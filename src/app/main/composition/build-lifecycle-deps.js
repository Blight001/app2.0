...
function buildLifecycleDeps({
  ...
  return {
    app,
    ipcMain,
    authorizeIpc: workspaceShell.authorizeIpc,
    workspaceType: 'browser',
    setBrowserDomainDisposer: workspaceShell.setBrowserDomainDisposer,
    getWorkspaceType: (event) => workspaceShell.identifySender(event),
    softwareWorkspace,
    fs,
    getStorePath,
    ...
    BrowserWindow,
    createMainWindow: workspaceShell.openHome,
    revealMainWindow: workspaceShell.revealHome,
    restoreHomeOnActivate: true,
